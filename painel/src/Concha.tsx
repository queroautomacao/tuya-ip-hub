...
// The shell owns the things every screen shares, the brand, the language, the theme and
...
function Icone({ aba }: { aba: Aba }) {
  // A few strokes drawn inline cost nothing on the wire and carry no font or icon
...
export function Marca({ subtitulo }: { subtitulo: string }) {
  // The brand of the company that sells the appliance, above the name of the
...
// The state of the daemon and the way out live at the foot of the rail on a desktop,
