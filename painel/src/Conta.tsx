...
// Everything about the appliance and its owner in one place, the daemon first because
...
import AcessoRemoto from "./AcessoRemoto.tsx";
import CartaoBackup from "./Backup.tsx";
import Licencas from "./Licencas.tsx";
import CartaoSeguranca from "./Seguranca.tsx";
...
// The daemon answers /health about seven seconds after it starts on the reference
...
function Reiniciar() {
  ...
  async function esperarVoltar(): Promise<void> {
    // The first answers are the daemon that is still going down, so the panel waits for
...
// On a desktop the rail of the shell shows this at its foot, always in view; a phone has
