...
// When a driver does not answer or a button of the app of the customer does nothing, the
...
// A hub under a scene writes a few lines a second, and a screen that redrew faster than
...
export default function Log() {
  ...
  // A log is read at the end, where what just happened is, so the box follows the last
  ...
  function copiar(): void {
    ...
    void (async () => {
      try {
        // A kiosk tablet on plain http has no clipboard API, so the fallback is the one
