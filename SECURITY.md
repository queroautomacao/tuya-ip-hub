...
Não existe recuperação de senha pela rede, e isso é decisão e não falha: quem alcança o diretório de dados do appliance já é dono dele, então `python -m iphub.esquecer` dentro do container apaga a senha e devolve o hub ao primeiro acesso, mantendo os equipamentos, as zonas e as cenas. O README explica.
