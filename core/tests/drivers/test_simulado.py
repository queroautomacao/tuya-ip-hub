...
"""The fake devices themselves, so a driver test never debugs its own bench."""
...
ESPERA_CURTA_S = 0.2
# The teardown has a deadline of its own, so the test waits longer than it to tell a
