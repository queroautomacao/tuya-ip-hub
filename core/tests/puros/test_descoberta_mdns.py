...
"""The mDNS query is generated from the manifests, like the SSDP sweep beside it.

 in spirit, and this is what the tests attack: an answer is data. A compression
...
def test_o_registro_a_que_nomeia_outro_host_nao_move_o_endereco(caplog):
    """The attack : an answer that points at another host would have this hub
...
def test_a_identidade_de_uma_resposta_mdns_fica_vazia():
    """An identity is a uuid, a mac or a serial, and an instance name is a name
...
def test_a_mesma_instancia_de_dois_remetentes_nao_dobra():
    """The attack on the fold: answering with the instance name of the speaker
