...
"""The minimum, PBKDF2-HMAC-SHA256, 200 thousand iterations, salt per install."""
...
@pytest.mark.parametrize(
    "senha", ["", "a", "1234567", "sete123", "       ", "a" * (SENHA_MINIMA - 1)]
)
...
def test_o_minimo_exato_e_aceito():
    salt_hex, hash_hex, iteracoes = gerar_hash("a" * SENHA_MINIMA)
...
def test_senha_com_surrogate_solto_deriva_e_confere(senha):
    # A lone surrogate arrives from JSON; before the guard it raised out of the route
